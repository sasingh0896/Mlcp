...
l14=new JLabel("Release Time");
l15=new JLabel("Release Date");
l16=new JLabel("Total Hours");
l12=new JLabel("");
l13=new JLabel("");
...
public void setUpParkingRecipt(String a43)
{
  ...
  a1=t1.getText();
	try
	{
		...
		{   
		  ...
		  t14.setText(rst.getString(12));
		  t15.setText(rst.getString(13));
		t16.setText(rst.getString(14));
		}
